...
def create_entity(pool, ctx, flags=None):
    '''store a new entity
...
def get_entity(pool, guid, ctx):
    ...
    '''
    with pool.get_by_guid(guid) as conn:
...
def add_entity_flags(pool, guid, ctx, flags):
...
def clear_entity_flags(pool, guid, ctx, flags):
...
def remove_entity(pool, guid, ctx):
    ...
    return txn.remove_entity(pool, guid, ctx)


def set_property(pool, base_id, ctx, value, flags=None):
    ...
    flags = util.int_to_flags(ctx, flags or [])
...
def get_property(pool, base_id, ctx):
...
def has_property(pool, base_id, ctx):
...
def increment_property(pool, base_id, ctx, by=1, limit=None):
...
def add_property_flags(pool, base_id, ctx, flags):
...
def clear_property_flags(pool, base_id, ctx, flags):
...
def remove_property(pool, base_id, ctx, value=_missing):
...
def set_alias(pool, base_id, ctx, value, flags=None):
    ...
    return txn.set_alias(pool, base_id, ctx, value, flags)


def lookup_alias(pool, value, ctx):
    ...
    :returns:
        ...
        ``ctx/value``
    '''
    result = txn.lookup_alias(pool, hashlib.sha1(value).digest(), ctx)
...
def list_aliases(pool, base_id, ctx):
...
def add_alias_flags(pool, base_id, ctx, value, flags):
    ...
    result = txn.add_alias_flags(pool, base_id, ctx, alias, flags)
...
def clear_alias_flags(pool, base_id, ctx, alias, flags):
    ...
    result = txn.clear_alias_flags(pool, base_id, ctx, alias, flags)
...
def remove_alias(pool, base_id, ctx, value):
    ...
    return txn.remove_alias(pool, base_id, ctx, alias)


def create_relationship(pool, ctx, base_id, rel_id, flags=None):
    ...
    return txn.create_relationship_pair(pool, base_id, rel_id, ctx, flags)


def list_relationships(pool, guid, ctx, forward=True):
...
def get_relationship(pool, ctx, base_id, rel_id):
...
def add_relationship_flags(pool, base_id, rel_id, ctx, flags):
    ...
    result = txn.add_relationship_flags(pool, base_id, rel_id, ctx, flags)
...
def clear_relationship_flags(pool, base_id, rel_id, ctx, flags):
    ...
    result = txn.clear_relationship_flags(pool, base_id, rel_id, ctx, flags)
...
def remove_relationship(pool, base_id, rel_id, ctx):
    ...
    return txn.remove_relationship_pair(pool, base_id, rel_id, ctx)


def create_tree_node(pool, base_id, ctx, value, flags=None):
...
def get_tree_node(pool, node_id, ctx):
    ...
    with pool.get_by_guid(node_id) as conn:
...
def list_tree_children(pool, base_id, ctx):
...
def update_tree_node(pool, node_id, ctx, value, old_value=_missing):
...
def increment_tree_node(pool, node_id, ctx, by=1, limit=None):
...
def add_tree_node_flags(pool, node_id, ctx, flags):
...
def clear_tree_node_flags(pool, node_id, ctx, flags):
...
def remove_tree_node(pool, node_id, ctx, base_id):
    ...
    return txn.remove_tree_node(pool, node_id, ctx, base_id)
